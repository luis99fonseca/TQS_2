insert into user (username, password, firstName, lastName, birthDate) values ('andrex','12345', 'Andre', 'Baiao', TO_DATE('04/02/2010', 'DD/MM/YYYY'));
insert into user (username, password, firstName, lastName, birthDate) values ('lius','12345', 'Luis', 'Fonseca', TO_DATE('17/12/2015', 'DD/MM/YYYY'));
insert into user (username, password, firstName, lastName, birthDate) values ('Silva', '12345',  'Joao', '', TO_DATE('17/02/1999', 'DD/MM/YYYY'));
insert into user (username, password, firstName, lastName, birthDate) values ('MandM', '12345', 'Miguel', 'Mota', TO_DATE('13/06/1930', 'DD/MM/YYYY'));
